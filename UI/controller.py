...
class Controller:
    ...
    def handleWorstCase(self, e):
        ...
        self._view._txtOut.controls.append(ft.Text(f"Tot people affected: {self._model.countCostumers(self._model._solBest)}"))
        self._view._txtOut.controls.append(ft.Text(f"Tot hours of outage: {self._model.sumHours(self._model._solBest)}"))
